...
const FLAGS = {
  ...
  "gap-scale":  {t:"Three different measurement frames", b:"The three positions on this axis are not measured the same way and are not strictly commensurable. \u201cTop 3 in the world\u201d is a global, lab-level judgement. \u201cRoughly top 60\u201d is an estimate of a training environment; the nearest hard figure behind it is Research.com placing UF computer science at #75 nationally and #128 worldwide. \u201c#30 national\u201d is US News\u2019s ranking of the whole institution \u2014 an institutional rank, not a measure of any lab, which is why it is drawn as a hollow reference point rather than as a third comparable measurement. The figure is here to show the size of the internal spread, not to assert precise ranks."},
